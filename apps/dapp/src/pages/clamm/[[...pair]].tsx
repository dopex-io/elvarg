  ...
  return (
    <PageLayout>
      ...
      <div className="flex flex-col w-full h-full p-[12px] space-y-[12px]">
        ...
        <div className="w-full h-full flex flex-col xl:flex-row xl:space-x-[12px] xl:space-y-[0px] space-y-[12px]">
          <div className="max-w-[1530px] sm:w-full w-[96vw] space-y-[12px]">
