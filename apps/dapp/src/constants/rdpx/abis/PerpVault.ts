const PerpVault = [
  ...
  },
  {
    ...
    name: 'PerpetualAtlanticVaultError',
    type: 'error',
  },
  {
    anonymous: false,
    ...
    inputs: [
      {
        ...
        indexed: false,
        internalType: 'struct IPerpetualAtlanticVault.Addresses',
        name: 'addresses',
        type: 'tuple',
      },
    ],
  ...
  },
  {
    inputs: [
      {
        internalType: 'uint256',
        name: '_fundingDuration',
        type: 'uint256',
      },
    ],
    name: 'updateFundingDuration',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
