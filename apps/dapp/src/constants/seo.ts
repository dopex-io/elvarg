...
const seo = {
  ...
  vedpx: {
    ...
    banner:
      'https://res.cloudinary.com/dxitdndu3/image/upload/v1684326258/dopex_images/preview_images/vedpx_sblho3.png',
    alt: 'veDPX',
  ...
  insuredPerps: {
    url: `${HOST_URL}/atlantics/`,
    banner:
      'https://res.cloudinary.com/dxitdndu3/image/upload/v1684326254/dopex_images/preview_images/insured-perps_fdog44.png',
    alt: 'Insured Perps',
  ...
  tzwap: {
    url: `${HOST_URL}/tzwap`,
    banner:
      'https://res.cloudinary.com/dxitdndu3/image/upload/v1684326256/dopex_images/preview_images/tzwap_z16g4c.png',
    alt: 'Tzwap',
    title: 'Tzwap',
  ...
  scalps: {
    url: `${HOST_URL}/scalps/`,
    banner:
      'https://res.cloudinary.com/dxitdndu3/image/upload/v1684326254/dopex_images/preview_images/option-scalps_dnnhuc.png',
    alt: 'Scalps',
