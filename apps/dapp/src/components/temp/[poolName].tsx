...
import PoolCard from 'components/straddles-legacy/Charts/PoolCard';
import TVLCard from 'components/straddles-legacy/Charts/TVLCard';
import Deposits from 'components/straddles-legacy/Deposits';
import Manage from 'components/straddles-legacy/Manage';
import Positions from 'components/straddles-legacy/Positions';
import Stats from 'components/straddles-legacy/Stats';
import TopBar from 'components/straddles-legacy/TopBar';
