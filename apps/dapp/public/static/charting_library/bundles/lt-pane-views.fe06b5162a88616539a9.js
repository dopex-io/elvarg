  ...
  [1583],
  {
            ...
            if (
              ...
              for (let t = 0; t < _; t++) {
                const i = Math.round(T + t * d + 0.5),
                  r = e(p[t]).map(
                    (e, t) => new n.Point(i + (2 * t - 1), Math.round(m(e)) + b)
                  ),
        ...
        _updateImpl() {
          ...
          for (let e = 0; e < h.length; e++) {
              ...
              }
            {
              ...
              s.setData(n),
                s.setHitTest(
                  new r.HitTestResult(r.HitTarget.MovePoint, void 0, h[e].index)
                ),
                g.append(s);
            }
          ...
          if (
            ...
            if (1 === this._points.length) {
              ...
              (e.data = 0),
                (e.square = !0),
                a.append(
                  this.createLineAnchor({ points: [e], pointsCursorType: c }, 0)
                );
            }
            if (1 === this._points.length) {
              const e = new n.Point(
      ...
      class A extends o.LineSourcePaneView {
        ...
        _creareMiddleLabel(e, t, i) {
          ...
          const R = _.qty.value() / _.lotSize.value(),
            y =
              'futures' === i.type || (0, w.isCryptoSymbol)(i)
        ...
        _updateImpl(e, t) {
          ...
          if (g && !this._noSelection) {
            ...
            if (_.wordWrapWidth) {
              ...
              (i.data = 1),
                e.append(
                  this.createLineAnchor({ points: [i], pointsCursorType: p }, 1)
                );
            }
    ...
    48063: (e, t, i) => {
      ...
      class W extends k.AlertableLineSourcePaneView {
        ...
        destroy() {
          this._cache && (this._cache.destroy(), (this._cache = null)),
            S.onAllIconsReady().unsubscribeAll(this);
        }
        iconsReady() {
        ...
        getCacheRects(e, t) {
          ...
          p ? (u -= 10 + d.height) : (u += 10),
            a !== V.StatsPosition.Auto ||
              (0, r.equalPoints)(
                l[V.StatsPosition.Left],
                l[V.StatsPosition.Right]
              ) ||
              (c < 0
                ? (c = 0)
              ...
              (0, s.intersectLineSegmentAndBox)(
                ...
                (c =
                  Math.min(l[V.StatsPosition.Center].x, e.cssWidth) -
                  d.width)));
          return {
            cacheRect: d,
            targetRect: {
          ...
          if (
            ...
            if (1 === this._points.length) {
              ...
              (t.data = 0),
                ...
                a.append(
                  this.createLineAnchor({ points: [t], pointsCursorType: c }, 0)
                );
            }
            this._renderer = a;
          }
        ...
        _drawImpl(e) {
          ...
          if (
            ...
            if (
              ...
              e.addColorStop(
                0,
                (0, r.generateColor)(this._data.color1, this._data.transparency)
              ),
                e.addColorStop(
                  1,
                  (0, r.generateColor)(
