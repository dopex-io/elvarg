(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7260],
  {
    ...
    23829: (e, t, s) => {
      ...
      function p(e) {
        ...
        return i
          ? a.createElement(
              'li',
              { className: n()(t, m.item, m.loading, m[T]) },
          ...
          : a.createElement(
              ...
              !w &&
                S &&
                a.createElement(c.Hint, { className: m.shortcut, text: S }),
    ...
    1109: (e, t, s) => {
      ...
      function o(e) {
        return a.createElement('div', {
          className: i(n.separator, e.className),
        });
      }
    },
    64264: (e) => {
    ...
    91348: (e) => {
      e.exports = {
        item: 'item-SqYYy1zF',
        isFirst: 'isFirst-SqYYy1zF',
        isLast: 'isLast-SqYYy1zF',
      };
    },
    22586: (e) => {
    ...
    54079: (e, t, s) => {
      ...
      const h = (0, a.forwardRef)(function (e, t) {
        const { onKeyDown: s, orientation: h, ...m } = e,
          p = r.PLATFORM_ACCESSIBILITY_ENABLED
          ...
          a.createElement('div', {
            ...
            onKeyDown: (0, n.createSafeMulticastEventHandler)(function (e) {
              ...
              const i = () => {
                  ...
                  (0, l.becomeSecondaryElement)(s[a]),
    ...
    92861: (e, t, s) => {
        ...
        return (
          ((t = class extends a.PureComponent {
            constructor(e, t) {
              ...
              const s = (this._binding = (0, g.ensureDefined)(
                k.get(t.chartWidget)
              ));
              this.state = s.state();
            }
      ...
      const j = {
          ...
          goToDate: (0, z.appendEllipsis)(n.t(null, void 0, s(369))),
        },
      ...
      function I(e) {
        return class extends a.PureComponent {
          ...
          componentDidUpdate() {
            ((0, g.ensureNotNull)(this._slider).style.transition =
              'transform 350ms'),
      ...
      var ae = s(88270),
        ...
        ce = s(10643),
        de = s(85616);
      const he = (0, H.mergeThemes)(P.DEFAULT_TOOLBAR_BUTTON_THEME, {
        isDisabled: de.disabled,
        button: de.button,
      });
          ...
          super(e, t),
            (this._timeFormatter = new ie.TimeFormatter(
              (0, re.getHourMinuteSecondFormat)(
                le.timeHoursFormatProperty.value()
              )
            )),
            ...
            (this._getActions = () => {
              ...
              return (function (e) {
                e.updateActions();
                const t = e.actions();
                return t && t.applyTimeZone instanceof ne.Action
            ...
            (this._showMenu = () => {
              if (this._preventShowingMenu)
                return void ce.ContextMenuManager.hideAll();
          ...
          (this._tickInterval = setInterval(this._tickClock, 1e3)),
            e.withModel(null, () => {
              ...
              t
                ...
                le.timeHoursFormatProperty.subscribe(
                  this,
          ...
          clearInterval(this._tickInterval),
            e.withModel(null, () => {
              ...
              t
                ...
                le.timeHoursFormatProperty.unsubscribe(
                  this,
                  this._timeHoursFormatPropertyChanged
                );
            });
          ...
          const { className: e, withMenu: t } = this.props,
            ...
            o =
              void 0 !== this._timezone
                ? (0, ae.parseTzOffset)(this._timezone.name()).string
                : null;
          return a.createElement(P.ToolbarButton, {
      ...
      var ze = s(42142),
        ...
        we = s(11678),
        De = s(97086);
      const je = new _e.TranslatedString(
          'change session',
              ...
              super(e, t),
                ...
                (this._handleSelect = () => {
                  ...
                  t.priceScale().isLockScale() ||
                    e.setPriceScaleMode({ log: !a.log }, s, Se);
                }),
                (0, _.validateRegistry)(t, { chartWidget: o.any.isRequired }),
                ...
                super(e, t),
                  ...
                  (this._handleSelect = () => {
                    const e = this.context.chartWidget.model(),
                      ...
                      a = s.mode();
                    t.priceScale().isLockScale() ||
                      e.setPriceScaleMode({ percentage: !a.percentage }, s, Ee);
                  }),
                  (0, _.validateRegistry)(t, {
                    chartWidget: o.any.isRequired,
                  }),
            ...
            a.createElement(
              ...
              s &&
                a.createElement(
                  'div',
                  {
                    className: r(Ie.inline, e.timeZones && Ie.collapsed),
              ...
              this.props.sessionIdButtonEnabled &&
                ...
                a.createElement(
                  'div',
                  {
                    className: r(Ie.inline, e.session && Ie.collapsed),
              ...
              a.createElement(
                'div',
                {
                  ...
                  className: r(Ie.inline, e.separator && Ie.collapsed),
                },
              ...
              a.createElement(
                ...
                i &&
                  ...
                  a.createElement(Ge, { className: Ie.icon }),
