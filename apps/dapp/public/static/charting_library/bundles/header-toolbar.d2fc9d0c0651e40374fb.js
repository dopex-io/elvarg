  ...
  [3005],
  {
    ...
    46618: (e, t, s) => {
      ...
      function y(e) {
        ...
        return n.createElement(
          ...
          !c &&
            n.createElement(
              'div',
              { className: g.separatorWrap },
              n.createElement(S, { className: g.separator })
            ),
          n.createElement(
            'div',
            {
              className: a(s, g.group, {
                [g.noMinimalWidth]: o,
                [g.noLeftDecoration]: r,
                [g.noRightDecoration]: i,
              }),
              onClick: l,
            },
            t
          ...
          ((o = class extends n.PureComponent {
            ...
            render() {
              const {
                ...
                { isVisibleRightButton: S, isVisibleLeftButton: g } =
                  this.state,
                y = d && h;
              return n.createElement(
                _.Measure,
      ...
      class ue {
        constructor(e) {
          (this._customIntervalsService = le),
            ...
            se.linking.intraday.subscribe(
              this._fireSupportedIntervalsMayChange
            ),
            se.linking.dataFrequencyResolution.subscribe(
              this._fireSupportedIntervalsMayChange
            );
        }
        destroy() {
          se.linking.supportedResolutions.unsubscribe(
            ...
            se.linking.seconds.unsubscribe(
              this._fireSupportedIntervalsMayChange
            ),
            se.linking.ticks.unsubscribe(this._fireSupportedIntervalsMayChange),
            se.linking.intraday.unsubscribe(
              this._fireSupportedIntervalsMayChange
            ),
            se.linking.dataFrequencyResolution.unsubscribe(
              this._fireSupportedIntervalsMayChange
            );
        }
        getDefaultIntervals() {
      ...
      class fe {
        ...
        favId(e) {
          return (0, me.isPineIdString)(e)
            ? e
            : (0, me.extractPineId)(e) || (0, he.extractStudyId)(e);
        }
        favorites() {
      ...
      function Ie(e = []) {
        return (0, Z.mergeResolutions)(
          e,
          d.enabled('star_some_intervals_by_default') ? we : []
        );
      }
      ...
      class Fe extends n.PureComponent {
        constructor(e) {
          ...
          this._favoriteChartStylesService =
            h || new $(ae.TVXWindowEvents, ie, b);
          const E = Ie(this.props.defaultFavoriteIntervals);
          (this._favoriteIntervalsService =
            l || new te(ae.TVXWindowEvents, ie, E)),
            (this._intervalsMenuViewStateService = new be(
              ae.TVXWindowEvents,
              ie
            )),
          ...
          return n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(
                'div',
                {
                  className: a(Ve.toolbar, { [Ve.isHidden]: !o }),
      ...
      class Oe {
        constructor(e, t) {
          (this._component = null),
            ...
            (this._container = e),
            r.render(
              n.createElement(Fe, { ...t, ref: this._handleRef }),
              this._container
            );
        }
        destroy() {
