(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2306],
  {
    ...
    3809: (t, e, o) => {
      'use strict';
      o.d(e, {
        FLOATING_TOOLBAR_REACT_WIDGETS_CLASS: () => C,
        FloatingToolbar: () => S,
      });
      var i = o(59064),
        n = o(32563),
      ...
      class y {
        ...
        _getEventTarget() {
          return m.CheckMobile.iOS() || ((0, m.isMac)() && n.touch)
        ...
        _initSortable() {
          ...
          lazyJqueryUI(this._content).sortable({
            ...
            stop: (e, o) => {
              ...
              t !== i &&
                ((0, b.trackEvent)('Floating Toolbar', 'User Sort'),
    ...
    89824: (t, e, o) => {
      ...
      function I(t) {
        ...
        const a = r[0].properties().frozen,
          ...
          c = l
            ...
            : { title: s.t(null, void 0, o(42284)), icon: D };
        return i.createElement(k, {
          className: n,
          isActive: Boolean(l),
          onClick: function () {
            (0, P.trackEvent)('GUI', 'Context action on drawings', 'Lock'),
      ...
      function A(t) {
        ...
        return i.createElement(S.ToolWidgetIconButton, {
          ...
          'data-name': 'remove',
          onClick: function () {
            (0, P.trackEvent)('GUI', 'Context action on drawings', 'Remove'),
      ...
      function G(t, e) {
        const i = [
            (0, U.createVisualOrderAction)(t, e),
            (0, U.createChangeIntervalsVisibilitiesAction)(t, e),
          ],
          n = (function (t, e) {
            const i = [],
              n = H.isMacKeyboard ? ' +' : '',
            ...
            r.length > 0 &&
              i.push(
                new Z.Action({
                  ...
                  icon: o(36296),
                  shortcutHint:
                    H.humanReadableModifiers(j.Modifiers.Mod) + n + ' Drag',
                  label: s.t(null, void 0, o(52977)),
                  onExecute: () => {
                    t.model().cloneLineTools(r, !1),
                      (0, P.trackEvent)(
                        'GUI',
            ...
            if (a.length > 0) {
              const e = {
                ...
                shortcutHint:
                  H.humanReadableModifiers(j.Modifiers.Mod) + n + ' C',
                onExecute: () => {
      ...
      function Y(t) {
        const {
          ...
          h = (0, i.useCallback)(
            () => d.contextMenuActionsForSources(r),
            [d, r]
          ),
          p = (0, i.useCallback)(() => {
            if (n) return;
