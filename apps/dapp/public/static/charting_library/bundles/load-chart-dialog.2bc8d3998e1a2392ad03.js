      ...
      function m(e) {
        ...
        return a.createElement(
          V,
          {
            ...
            'aria-selected': m,
            'aria-checked': d,
            className: o(h, Z.item, _ && Z.withIcon, {
              [Z.isActive]: b,
              [Z.isDisabled]: w || k,
              [Z.hovered]: C,
            }),
      ...
      function c(e, t) {
        return (n, c) => {
          const u = (0, l.ensureNotNull)(e).getBoundingClientRect(),
            ...
            w = {
              x: _ - (y === i.FromRightToLeft ? n : 0) + f,
              y: b - (d === r.FromBottomToTop ? c : 0) + v,
            };
      ...
      function J(e) {
        ...
        return (
          ...
          a.createElement(Z.DialogContentItem, {
            url: _,
            title: a.createElement(q.HighlightedText, {
              className: k,
              queryString: m,
              rules: C,
              text: t.title,
            ...
            subtitle: a.createElement(
              a.Fragment,
              null,
              a.createElement(q.HighlightedText, {
                className: k,
                queryString: m,
                rules: C,
                text: t.description,
