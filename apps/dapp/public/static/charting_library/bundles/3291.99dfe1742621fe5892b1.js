      ...
      function a(e) {
        ...
        return (
          ...
          (0, o.useIsomorphicLayoutEffect)(() => {
            if (null !== t.current)
              return u.current(t.current), () => u.current(null);
          }, [e]),
          t
        );
      }
          ...
          return (
            ...
            r.createElement(u.ToolWidgetMenu, {
              ...
              onMenuKeyDown: function (e) {
                ...
                const o = document.activeElement.closest(
                  '[data-role="menuitem"]'
                );
                ...
                const u = h(o),
                  ...
                  f = -1 !== c,
                  p = (e) => {
                    n && (0, l.becomeSecondaryElement)(n),
                ...
                switch (t) {
                  case 37:
                    if (!u.length) return;
                    e.preventDefault(),
                      p(0 === c ? r[a] : f ? m(u, c, -1) : u[u.length - 1]);
                    break;
                  case 39:
                    if (!u.length) return;
                    e.preventDefault(),
                      c === u.length - 1 ? p(r[a]) : p(f ? m(u, c, 1) : u[0]);
                    break;
                  case 38: {
                    e.preventDefault();
                    const t = m(r, a, -1);
