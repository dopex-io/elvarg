(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4862],
  {
    ...
    23263: (e, t, n) => {
        ...
        return o.createElement(
          ...
          i &&
            o.createElement(s.Icon, {
              className: f()(_().icon, _().startIcon),
              icon: i,
            }),
          !(0, b.isIconOnly)(n, r) &&
      ...
      i.t(null, void 0, n(87871)),
        i.t(null, void 0, n(10538)),
        i.t(null, void 0, n(74860));
      var M = n(29540),
        D = n(28355);
      ...
      const z = new l.TranslatedString(
          'remove all line tools for {symbol}',
          i.t(null, void 0, n(23481))
        ),
        j = (e) =>
          i
        ...
        return (
          ...
          o.createElement(
            ...
            0 === b.length
              ...
              : b.map(
                  ({ symbol: e, drawingsCount: n, onRemove: r, onClick: s }) =>
    ...
    82497: (e, t, n) => {
      ...
      function* Xe(e) {
        ...
        !Ge(yield (0, S.select)()) &&
          t.length > 0 &&
          (yield (0, S.put)(Ie(t[0])), yield (0, S.put)(ke(t[0])));
      }
      function* et(e) {
        for (;;) {
      ...
      function* ot(e, t = () => !0) {
        for (;;) {
          ...
          if (1 === n) r ? s.push(o) : s.splice(s.indexOf(o), 1);
            ...
            -1 === n &&
              (n = i.reduce((e, t, n) => (s.includes(t.id) ? n : e), -1));
      ...
      const Dt = (e) => {
          ...
          return (
            (bt.CheckMobile.any() || bt.CheckMobile.isIPad()) &&
              ((S = n), (w = { onMouseOut: Et, onMouseOver: Et })),
            o.createElement(
              'div',
              {
                className: I(
            ...
            hover: (n, o) => {
              ...
              if ('last' === e.type) {
                const t = r.x - i.left < 48,
                  ...
                  o =
                    t && 2 === n.level
                      ? (0, T.ensureDefined)(s.find((e) => e.id === n.parentId))
                      : n,
                  a = {
                    top: i.top - l.top,
                    left: i.left - l.left,
            ...
            o.createElement(
              ...
              o.createElement(
                'div',
                {
                  ...
                  onClick: function (e) {
                    if (e.defaultPrevented) return;
                    if (!(e.target instanceof Element) || null === i.current)
                      return;
      ...
      function Nn(e) {
        ...
        return o.createElement(E.Icon, {
          className: k()(Dn.button, n && Dn.disabled, t),
          ...r,
        });
      }
      var xn = n(77975);
      ...
      function Kn(e) {
        ...
        (0, o.useEffect)(() => {
          ...
          (0, o.useEffect)(() => {
            !i && W.current && (clearTimeout(W.current), (W.current = null)),
              b(!1);
          }, [i]);
        const H = {};
        if (c) {
      ...
      var lo = n(36298),
        ...
        vo = n(57674),
        bo = n(46627);
      const yo = new lo.TranslatedString(
          'show {title}',
          v.t(null, void 0, n(87358))
        ),
        _o = new lo.TranslatedString(
          'hide {title}',
      ...
      class Jo {
        ...
        async openContextMenu(e, t, n) {
          ...
          if (this._objects.some((e) => e.hasChildren()))
            s = this._getActionsForGroupItem(e, t, r);
          else {
          ...
          if (s.length > 0) {
            ...
            (a = i
              ...
              jo.ContextMenuManager.showMenu(
                s,
                n,
        ...
        _getActionsForGroupItem(e, t, n) {
          ...
          const s = (0, go.createSyncDrawingActions)(
            this._chart.value(),
