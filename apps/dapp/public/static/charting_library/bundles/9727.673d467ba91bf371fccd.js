    ...
    5648: (e, t, n) => {
      ...
      function b(e) {
        ...
        const {
          ...
          ce = !1,
          ue =
            null !== (t = null == F ? void 0 : F.description) && void 0 !== t
              ? t
              : Q,
          de =
            null !== (n = null == F ? void 0 : F.name) && void 0 !== n ? n : Q;
        return r.createElement(
          'div',
          {
            className: a()(
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                !te &&
                  r.createElement(
                    'div',
                    { className: a()(g.marketType, I && g.active) },
                    k
                  ),
                r.createElement(
                  'div',
          ...
          r.createElement(
            'div',
            { className: a()(g.cell, Boolean(j) && g.actionsCell) },
            j
          )
        );
        function me() {
    ...
    32456: (e, t, n) => {
      ...
      function O(e) {
        const { searchSources: t } = e,
          ...
          d =
            (0, I.useWatchedValueReadonly)({ watchedValue: T.watchedTheme }) ===
            L.StdTheme.Dark
              ? _
              : D,
          [m, g] = (0, r.useState)(''),
          y = (0, r.useMemo)(
            () => [{ group: null, sources: (0, f.filterSearchSources)(t, m) }],
            [t, m]
          ),
          x = (0, r.useRef)(null),
          w = (0, r.useRef)(null);
      ...
      function ke(e) {
        const {
          ...
          R = (0, r.useMemo)(
            () =>
              x.map((e) => r.createElement(L, { ...e, searchToken: E.token })),
            [x]
          );
        return r.createElement(
          r.Fragment,
            ...
            r.createElement(
              ...
              y.length > 0 &&
                r.createElement(
                  ...
                  !g &&
                    r.createElement('div', { className: xe.brokerButton }, I)
                ),
              !k.isSeparateSymbolSearchTabs &&
                g &&
                y.length > 0 &&
              ...
              k.isSeparateSymbolSearchTabs &&
                r.createElement(fe, { brokerButton: g ? I : void 0 })
            ),
          r.createElement(ye, {
            listRef: d,
            listWrapRef: m,
          ...
          'symbolSearch' === f &&
            r.createElement(
              ...
              null,
              !1,
              'empty' === N && r.createElement(C, null)
            )
        );
      }
      function Ce(e) {
      ...
      function Ie(e) {
        ...
        (0, r.useEffect)(
          ...
          (0, r.useEffect)(() => {
            ...
            if (!u.enabled('show_spread_operators'))
              return (x.current.value = E.symbol), void N();
                ...
                (le.current = setTimeout(() => {
                  y({
                    ...
                    canChangeExchange: Boolean(
                      d && V.length > 1 && !(0, k.exchangeSelectDisabled)(t)
                    ),
        ...
        function Te() {
          'watchlist' === q.current &&
            (o('symbolSearch'),
            (0, W.trackEvent)('Watchlist', 'Mobile SS', 'Go to SS page'));
        }
        function Le(e) {
      ...
      function Ue(e) {
        ...
        (0, r.useLayoutEffect)(() => {
          ...
          !(null == ve ? void 0 : ve.current) ||
            (!K &&
              Boolean(
                null === (e = ve.current) || void 0 === e ? void 0 : e.value
              )) ||
        ...
        function st(e) {
          ...
          (ve.current.value = t),
            ve.current.setSelectionRange(n, n),
            ve.current.focus();
        }
        function it(e) {
          switch ((0, U.hashFromEvent)(e)) {
        ...
        function ct(e) {
          ...
          if (u.enabled('show_spread_operators') && re && t) {
            ...
            if (
              (n &&
                void 0 !== n.isExpanded &&
                (n.onClick(), (t = ve.current.value)),
              t.includes(','))
            ) {
              return ut(je(t).map(Ze)), void (e && o());
            }
            return (
              ut([{ symbol: We ? t.toUpperCase() : t, resolved: !1 }]),
              void (e && o())
            );
          }
          ...
          const {
            ...
            E =
              ...
              ('string' == typeof s
                ...
                : r.cloneElement(s, {
                    className: o(g.icon, s.props.className),
                  }));
          return 'button' === n
            ? r.createElement(
                'button',
