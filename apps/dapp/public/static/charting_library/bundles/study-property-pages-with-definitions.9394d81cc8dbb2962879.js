        ...
        _getInputSourceItems() {
          ...
          if (this._source && this._source.isChildStudy()) {
            ...
            for (const t of Object.keys(a))
              e.push({ id: t, value: t, title: a[t] });
          }
          if (
            a.enabled('study_on_study') &&
            this._source &&
            (this._source.isChildStudy() ||
              m.StudyMetaInfo.canBeChild(this._source.metaInfo()))
          ) {
              ...
              .forEach((t) => {
                ...
                if (1 === s.length) e.push({ id: n, value: n, title: i });
                  ...
                  const t = s.reduce((e, t, r) => {
                    if (!m.StudyMetaInfo.canPlotBeSourceOfChildStudy(t.type))
                      return e;
                    let s;
                    try {
                      s = (0, l.ensureDefined)(
                        (0, l.ensureDefined)(a)[t.id]
                      ).title;
                    } catch (e) {
                      s = t.id;
                    }
