          ...
          <Box className="pt-28 md:pt-32 pb-32 lg:max-w-9xl md:max-w-7xl sm:max-w-xl mx-auto px-4 lg:px-0">
            ...
            <Box className="p-2 mt-7 md:flex">
              <Box className="md:w-1/3 p-4 text-center">
                ...
                >
                  This mint experience only requires you to stake LP tokens to
                  get your Diamond Pepe(s).
                </Typography>
                <Typography
                  variant="h4"
              ...
              <Box className="md:w-1/3 p-4 text-center">
                ...
                <Typography
                  ...
                  className="text-[#78859E] font-['Minecraft'] relative z-1 mt-4"
                >
                  You can mint your NFT when the deposit period ends. This is
                  set for two days from opening pool.
                </Typography>
                <Typography
                  variant="h4"
                  className="text-[#78859E] font-['Minecraft'] relative z-1 mt-5"
              ...
              <Box className="md:w-1/3 p-4 text-center">
                ...
                <Typography
                  ...
                  className="text-[#78859E] font-['Minecraft'] relative z-1 mt-4"
                >
                  Your stake is locked for 14 days. Once unlocked you can
