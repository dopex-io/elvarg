        ...
        <Box>
          <Box className="flex flex-row items-center mb-4 pt-1">
            ...
            <Popover
              anchorEl={anchorEl}
              open={!!anchorEl}
              classes={{ paper: `${background[1]} rounded-md` }}
          ...
          >
            <Box className="flex flex-row justify-between">
              <Box
                className={`h-11 ${background[0]} rounded-full pl-1 pr-1 pt-0 pb-0 flex flex-row items-center cursor-pointer group`}
                            ...
                            <Box className="w-64 pb-3 pt-0 p-2">
                              {swapSteps.map((step) => (
                                <Box key={step['pair']}>
                                  ...
                                  <Box
                                    className={`rounded-md flex flex-col p-3 border border-neutral-800 ${background[1]}`}
                                  >
                                    {step['dexes'].map((dex) => (
                          ...
                          <Box className="flex">
                            {swapSymbols.slice(0, 3).map((symbol, index) => (
                              <Box key={symbol} className="flex mr-2">
                                <Box
                                  className={`rounded-md flex p-1 border border-neutral-800 ${background[3]} mt-3`}
                                >
                                  <Box
                                    className={`rounded-md flex flex-col mb-0 p-1 ${background[4]}`}
                                  >
                                    <img
          ...
          >
            <Box
              className={`rounded-md flex mb-4 p-3 border border-neutral-800 w-full ${background[1]} cursor-pointer`}
            >
