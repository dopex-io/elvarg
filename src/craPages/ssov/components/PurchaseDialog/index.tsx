...
const PurchaseDialog = ({
  ...
  return (
    <Dialog
      ...
      classes={{
        paper: 'rounded m-0',
        paperScrollPaper: 'overflow-hidden h-[54.5rem]',
      }}
    >
      <Box>
        <Box className="flex flex-row items-center mb-4">
          ...
          {isZapActive && (
            <Box
              className="rounded-md flex r-0 ml-auto p-1.5 pt-1 border border-neutral-800 bg-neutral-700 cursor-pointer hover:bg-neutral-600"
              onClick={() => {
