...
const PurchaseDialog = ({
  ...
  return (
    <Dialog
      ...
      classes={{
        paper: 'rounded m-0',
        paperScrollPaper: 'overflow-hidden h-[56rem]',
      }}
    >
      <Box>
        <Box className="flex flex-row items-center mb-4">
          ...
          <Box
            className={
              isZapActive
                ? 'rounded-md flex r-0 ml-auto p-1.5 pt-1 border border-neutral-800 bg-neutral-700 cursor-pointer hover:bg-neutral-600'
