...
import MetavaultDescription from '../components/MetavaultDescription';
import MetavaultCard from '../components/MetavaultCard';
        ...
        <Box className="flex flex-col mt-20">
          <Box className="flex md:flex-row flex-col mb-4 md:justify-between items-center md:items-start">
            <MetavaultDescription
              ...
              userSsovData={userSsovData}
            />
            <MetavaultCard ssovProperties={ssovProperties} />
          </Box>
        </Box>
      </Box>
    </Box>
