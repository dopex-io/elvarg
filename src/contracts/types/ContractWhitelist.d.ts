...
interface ContractWhitelistInterface extends ethers.utils.Interface {
  functions: {
...
export class ContractWhitelist extends BaseContract {
  ...
  interface: ContractWhitelistInterface;
