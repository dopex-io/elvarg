...
interface OptionsTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class OptionsToken extends BaseContract {
  ...
  interface: OptionsTokenInterface;
  ...
  functions: {
    ...
    atlanticPool(overrides?: CallOverrides): Promise<[string]>;
    ...
    'initialize(address,address,address,bool,uint256,uint256,uint256)'(
      _atlanticPool: string,
      _baseToken: string,
      _quoteToken: string,
      _isPut: boolean,
  ...
  estimateGas: {
    ...
    atlanticPool(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    atlanticPool(overrides?: CallOverrides): Promise<PopulatedTransaction>;
