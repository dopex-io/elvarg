...
import Description from 'components/ssov-page/V3/Description';
import ManageCard from 'components/ssov-page/V3/ManageCard';
import ExerciseList from 'components/ssov-page/V3/ExerciseList';
import Stats from 'components/ssov-page/V3/Stats';
import PageLoader from 'components/PageLoader';

import { SsovV3Context, SsovV3Provider } from 'contexts/SsovV3';
import WritePositions from 'components/ssov-page/V3/WritePositions';

const Manage = () => {
  const router = useRouter();
  const ssov = router.query.symbol;
