const SsovV3RouterAbi = [
  { inputs: [], name: 'OneInchSwapFailed', type: 'error' },
  ...
  {
    inputs: [
      { internalType: 'contract ISsovV3', name: '_ssov', type: 'address' },
      { internalType: 'uint256', name: '_strikeIndex', type: 'uint256' },
      { internalType: 'uint256', name: '_collateralAmount', type: 'uint256' },
    ],
    name: 'computeAmountOfOptions',
    outputs: [
      { internalType: 'uint256', name: 'amountOfOptions', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_minReturnAmount', type: 'uint256' },
...
export default SsovV3RouterAbi;
