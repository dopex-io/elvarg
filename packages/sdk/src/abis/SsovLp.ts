const SsovLpAbi = [
  ...
  { inputs: [], name: 'InsuffientLiquidity', type: 'error' },
  { inputs: [], name: 'InvalidDiscount', type: 'error' },
  { inputs: [], name: 'InvalidEpochToFill', type: 'error' },
  { inputs: [], name: 'InvalidLiquidity', type: 'error' },
  { inputs: [], name: 'InvalidLpIndex', type: 'error' },
  { inputs: [], name: 'InvalidParams', type: 'error' },
  { inputs: [], name: 'InvalidStrike', type: 'error' },
  { inputs: [], name: 'LpPositionDead', type: 'error' },
  { inputs: [], name: 'OnlyBuyerCanKill', type: 'error' },
  { inputs: [], name: 'SsovDoesNotExist', type: 'error' },
  { inputs: [], name: 'SsovEpochExpired', type: 'error' },
  {
    anonymous: false,
    inputs: [
      {
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: 'address', name: 'assetSwapper', type: 'address' },
        ],
        indexed: false,
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bool', name: 'isUsd', type: 'bool' },
      ...
      { internalType: 'uint256', name: 'maxTokensToFill', type: 'uint256' },
  ...
  },
  {
    inputs: [
      { internalType: 'bool', name: 'isPut', type: 'bool' },
      { internalType: 'bool', name: 'outUsd', type: 'bool' },
      { internalType: 'address', name: 'strikeToken', type: 'address' },
      { internalType: 'uint256', name: 'lpIndex', type: 'uint256' },
      { internalType: 'uint256', name: 'amount', type: 'uint256' },
      { internalType: 'uint256', name: 'minAmountOut', type: 'uint256' },
      { internalType: 'uint256', name: 'swapperId', type: 'uint256' },
    ],
    name: 'fillLpPosition',
    outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [{ internalType: 'address', name: 'strikeToken', type: 'address' }],
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'uint256', name: 'strike', type: 'uint256' },
          { internalType: 'uint256', name: 'usdLiquidity', type: 'uint256' },
          {
            internalType: 'uint256',
          ...
          { internalType: 'bool', name: 'killed', type: 'bool' },
        ],
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'address', name: 'ssov', type: 'address' },
      { internalType: 'uint256', name: 'strike', type: 'uint256' },
      { internalType: 'uint256', name: 'usdLiquidity', type: 'uint256' },
      { internalType: 'uint256', name: 'underlyingLiquidity', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [
      { internalType: 'address', name: 'ssov', type: 'address' },
      { internalType: 'uint256', name: 'usdPremium', type: 'uint256' },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bool', name: 'outUsd', type: 'bool' },
      { internalType: 'address', name: 'strikeToken', type: 'address' },
      { internalType: 'uint256[]', name: 'lpIndices', type: 'uint256[]' },
      { internalType: 'uint256[]', name: 'amount', type: 'uint256[]' },
