const NativeSSOV1inchRouterAbi = [
  {
    inputs: [
  ...
  },
  {
    ...
    name: 'ssov',
    outputs: [
      { internalType: 'contract INativeSSOV', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bytes', name: '_data', type: 'bytes' },
      {
        ...
        internalType: 'struct NativeSSOV1inchRouter.PurchaseOption',
        name: '_params',
        type: 'tuple',
      },
    ],
...
export default NativeSSOV1inchRouterAbi;
