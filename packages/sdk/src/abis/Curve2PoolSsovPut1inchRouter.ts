const Curve2PoolSsovPut1inchRouterAbi = [
  {
    inputs: [
      {
      ...
      { internalType: 'address', name: '_crv2Token', type: 'address' },
  ...
  },
  {
    ...
    name: 'swapAndDepositMultipleFromSingle',
    outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    inputs: [
      ...
      { internalType: 'bytes', name: '_data', type: 'bytes' },
      {
        ...
        internalType: 'struct Curve2PoolSsovPut1inchRouter.PurchaseOption',
        name: '_params',
        type: 'tuple',
      },
      { internalType: 'address', name: '_ssov', type: 'address' },
  ...
  },
  {
    ...
    name: 'swapAndPurchaseFromSingle',
    outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
...
export default Curve2PoolSsovPut1inchRouterAbi;
