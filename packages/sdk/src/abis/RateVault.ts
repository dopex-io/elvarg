const RateVaultAbi = [
  {
    inputs: [
      ...
      { internalType: 'address', name: '_crvLP', type: 'address' },
      { internalType: 'address', name: '_crvPool', type: 'address' },
    ],
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_expiry', type: 'uint256' }],
    name: 'bootstrap',
    outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'rateAtSettlement', type: 'uint256' },
  ...
  },
  {
    ...
    name: 'crvLP',
    outputs: [
      { internalType: 'contract ICrv2Pool', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [
      { internalType: 'uint256[]', name: 'callsLeverages', type: 'uint256[]' },
      { internalType: 'uint256[]', name: 'putsLeverages', type: 'uint256[]' },
    ],
    name: 'setLeverages',
    outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [{ internalType: 'uint256[]', name: 'strikes', type: 'uint256[]' }],
    name: 'setStrikes',
    outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    ...
    name: 'totalEpochData',
    outputs: [
      { internalType: 'uint256', name: 'totalCallsDeposits', type: 'uint256' },
      { internalType: 'uint256', name: 'totalPutsDeposits', type: 'uint256' },
      { internalType: 'uint256', name: 'totalTokenDeposits', type: 'uint256' },
      { internalType: 'uint256', name: 'epochCallsPremium', type: 'uint256' },
      { internalType: 'uint256', name: 'epochPutsPremium', type: 'uint256' },
      { internalType: 'uint256', name: 'totalCallsPurchased', type: 'uint256' },
      { internalType: 'uint256', name: 'totalPutsPurchased', type: 'uint256' },
      { internalType: 'uint256', name: 'epochStartTimes', type: 'uint256' },
      { internalType: 'uint256', name: 'epochExpiryTime', type: 'uint256' },
      { internalType: 'bool', name: 'isEpochExpired', type: 'bool' },
      { internalType: 'bool', name: 'isVaultReady', type: 'bool' },
      {
        internalType: 'uint256',
        name: 'epochBalanceAfterUnstaking',
        type: 'uint256',
      },
      { internalType: 'uint256', name: 'crvToDistribute', type: 'uint256' },
      { internalType: 'uint256', name: 'rateAtSettlement', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'totalCallsPurchased', type: 'uint256' },
      { internalType: 'uint256', name: 'totalPutsPurchased', type: 'uint256' },
      { internalType: 'uint256', name: 'callsSettlement', type: 'uint256' },
      { internalType: 'uint256', name: 'putsSettlement', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'amount', type: 'uint256' },
      { internalType: 'uint256', name: 'callLeverage', type: 'uint256' },
      { internalType: 'uint256', name: 'putLeverage', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'putsPurchased', type: 'uint256' },
      { internalType: 'uint256', name: 'callsPurchased', type: 'uint256' },
      {
        internalType: 'uint256',
