const DuelDiamondPepesNFTsDuelAbi = [
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_challengeTimelimit', type: 'uint256' },
      { internalType: 'uint256', name: '_revealTimeLimit', type: 'uint256' },
    ],
  ...
  },
  {
    inputs: [],
    name: 'dp2',
    outputs: [{ internalType: 'contract IDP2Mint', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
export default DuelDiamondPepesNFTsDuelAbi;
