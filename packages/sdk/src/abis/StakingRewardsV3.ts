const StakingRewardsV3Abi = [
  ...
  },
  {
    ...
    name: 'rewardPerToken',
    outputs: [
      { internalType: 'uint256', name: 'perTokenRate', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_boost', type: 'uint256' }],
    name: 'updateBoost',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
...
export default StakingRewardsV3Abi;
