const PerpetualAtlanticVaultAbi = [
  {
    inputs: [
      { internalType: 'string', name: '_name', type: 'string' },
      { internalType: 'string', name: '_symbol', type: 'string' },
      { internalType: 'string', name: '_underlyingSymbol', type: 'string' },
  ...
  { inputs: [], name: 'E10', type: 'error' },
  { inputs: [], name: 'E11', type: 'error' },
  { inputs: [], name: 'E12', type: 'error' },
  { inputs: [], name: 'E13', type: 'error' },
  { inputs: [], name: 'E14', type: 'error' },
  { inputs: [], name: 'E15', type: 'error' },
  { inputs: [], name: 'E16', type: 'error' },
  ...
  { inputs: [], name: 'E8', type: 'error' },
  { inputs: [], name: 'E9', type: 'error' },
  {
    anonymous: false,
    inputs: [
      {
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: 'address', name: 'ethPriceOracle', type: 'address' },
          { internalType: 'address', name: 'dopexAMMFactory', type: 'address' },
        ],
        indexed: false,
        internalType: 'struct IPerpetualAtlanticState.Addresses',
        name: 'addresses',
        type: 'tuple',
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'address', name: 'assetPriceOracle', type: 'address' },
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'totalCollateral', type: 'uint256' },
      { internalType: 'uint256', name: 'activeCollateral', type: 'uint256' },
      { internalType: 'uint256', name: 'accuredPremium', type: 'uint256' },
      {
        internalType: 'uint256',
  ...
  {
    inputs: [],
    name: 'latestFundingPaymentPointer',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [],
    name: 'nextFundingPaymentTimestamp',
  ...
  },
  {
    ...
    name: 'nextFundingPaymentTimestamps',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_pointer', type: 'uint256' },
    ],
    name: 'updateFundingPaymentEmergency',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'totalCollateral', type: 'uint256' },
      { internalType: 'uint256', name: 'activeCollateral', type: 'uint256' },
      { internalType: 'uint256', name: 'totalPremium', type: 'uint256' },
      { internalType: 'uint256', name: 'positionPointer', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    name: 'withdrawUnusedCollateral',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
];
export default PerpetualAtlanticVaultAbi;
