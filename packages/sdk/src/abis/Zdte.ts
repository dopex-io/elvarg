const ZdteAbi = [
  {
    inputs: [
      ...
      { internalType: 'address', name: '_volatilityOracle', type: 'address' },
      ...
      { internalType: 'uint256', name: '_strikeIncrement', type: 'uint256' },
      { internalType: 'uint256', name: '_maxOtmPercentage', type: 'uint256' },
      { internalType: 'uint256', name: '_genesisExpiry', type: 'uint256' },
      { internalType: 'string', name: '_oracleId', type: 'string' },
    ],
  ...
  },
  {
    inputs: [],
    name: 'baseLp',
    outputs: [{ internalType: 'contract ZdteLP', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'longStrike', type: 'uint256' },
      { internalType: 'uint256', name: 'shortStrike', type: 'uint256' },
    ],
    name: 'calcMargin',
    outputs: [{ internalType: 'uint256', name: 'margin', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    name: 'expiryInfo',
    outputs: [
      { internalType: 'bool', name: 'begin', type: 'bool' },
      { internalType: 'uint256', name: 'expiry', type: 'uint256' },
      { internalType: 'uint256', name: 'startId', type: 'uint256' },
      { internalType: 'uint256', name: 'count', type: 'uint256' },
      { internalType: 'uint256', name: 'settlementPrice', type: 'uint256' },
      { internalType: 'uint256', name: 'lastProccessedId', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_spreadMarginSafety', type: 'uint256' },
    ],
  ...
  },
  {
    inputs: [
      {
        internalType: 'uint256',
        name: '_maxLongStrikeVolAdjust',
        type: 'uint256',
      },
    ],
    name: 'updateMaxLongStrikeVolAdjust',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    inputs: [
      {
        internalType: 'uint256',
        name: '_minLongStrikeVolAdjust',
        type: 'uint256',
      },
    ],
    name: 'updateMinLongStrikeVolAdjust',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    inputs: [{ internalType: 'string', name: '_oracleId', type: 'string' }],
    name: 'updateOracleId',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'bool', name: 'isPut', type: 'bool' },
      { internalType: 'bool', name: 'isSpread', type: 'bool' },
      { internalType: 'uint256', name: 'positions', type: 'uint256' },
      { internalType: 'uint256', name: 'longStrike', type: 'uint256' },
      { internalType: 'uint256', name: 'shortStrike', type: 'uint256' },
      { internalType: 'uint256', name: 'longPremium', type: 'uint256' },
      { internalType: 'uint256', name: 'shortPremium', type: 'uint256' },
