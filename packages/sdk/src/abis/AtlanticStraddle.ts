const AtlanticStraddleAbi = [
  {
    inputs: [
      ...
      { internalType: 'string', name: '_symbol', type: 'string' },
      {
        ...
        internalType: 'struct AtlanticStraddle.Addresses',
        name: '_addresses',
        type: 'tuple',
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      {
        internalType: 'uint256',
        name: 'finalUsdBalanceBeforeWithdaw',
        type: 'uint256',
      },
    ],
    stateMutability: 'view',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_apFundingPercent', type: 'uint256' },
    ],
    name: 'setApFunding',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    name: 'setBlackoutPeriodBeforeExpiry',
    outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    inputs: [
      { internalType: 'uint256', name: '_purchaseFeePercent', type: 'uint256' },
      {
        internalType: 'uint256',
        name: '_settlementFeePercent',
        type: 'uint256',
      },
      {
        internalType: 'uint256',
        name: '_delegationFeePercent',
        type: 'uint256',
      },
      { internalType: 'uint256', name: '_maxDelegationFee', type: 'uint256' },
    ],
    name: 'setFees',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_pnlSlippagePercent', type: 'uint256' },
    ],
    name: 'setPnlSlippagePercent',
    outputs: [],
    stateMutability: 'nonpayable',
...
export default AtlanticStraddleAbi;
