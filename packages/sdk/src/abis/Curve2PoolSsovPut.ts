const Curve2PoolSsovPutAbi = [
  ...
  {
    inputs: [
      { internalType: 'uint256[]', name: 'strikeIndices', type: 'uint256[]' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'int256', name: 'coinIndex', type: 'int256' },
    ],
...
export default Curve2PoolSsovPutAbi;
